...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/sub_unit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_unit.tcl
