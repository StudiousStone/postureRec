...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/head_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log head_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source head_fifo.tcl
