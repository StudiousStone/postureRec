...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/fifo_shift_window_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_shift_window.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_shift_window.tcl
