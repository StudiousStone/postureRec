...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/combine2data_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combine2data_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combine2data_fifo.tcl
