...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/floating_point_compare_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_compare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_compare.tcl
