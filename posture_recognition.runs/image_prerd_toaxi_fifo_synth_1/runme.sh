...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/image_prerd_toaxi_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_prerd_toaxi_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_prerd_toaxi_fifo.tcl
