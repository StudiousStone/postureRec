...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/stayInstep_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stayInstep_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stayInstep_fifo.tcl
