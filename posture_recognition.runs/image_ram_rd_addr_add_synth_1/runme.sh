...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/image_ram_rd_addr_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_ram_rd_addr_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_ram_rd_addr_add.tcl
