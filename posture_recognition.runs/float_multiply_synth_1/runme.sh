...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/float_multiply_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_multiply.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_multiply.tcl
