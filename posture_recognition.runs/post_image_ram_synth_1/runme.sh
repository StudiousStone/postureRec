...
HD_PWD='D:/postureRec/posture_recognition/posture_recognition.runs/post_image_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log post_image_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source post_image_ram.tcl
