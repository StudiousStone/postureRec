...
#
# Generated by export_simulation on Sun Jun 24 09:28:56 +0800 2018
#
################################################################################
...
./float_add_IP_use_DSP_multilatency.sh
...
'-reset_run' switch to the './float_add_IP_use_DSP_multilatency.sh' script.

./float_add_IP_use_DSP_multilatency.sh -reset_run
...
./float_add_IP_use_DSP_multilatency.sh -noclean_files

For more information on the script, please type './float_add_IP_use_DSP_multilatency.sh -help'.
