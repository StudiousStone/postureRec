...
output reg	image_rd_need;//need to read image from axi
input	image_wr_finish;//the last image data
...
reg [`IMAGE_SIZE+`IMAGE_SIZE-1:0]	image_wr_size2_div_in_load_image_clk_domain;
reg [`IMAGE_SIZE+`IMAGE_SIZE-1:0]	image_wr_size2_div_in_load_image_clk_domain_r;
...
reg [7:0] load_image_rd_pointer_inRAM;
