...
// Engineer: An Pingbo
// 
// Create Date: 2017/09/18 16:33:19
// Design Name: 
// Module Name: post_to_ram_virtual_path
// Project Name: 
// Target Devices: 
// Tool Versions: 
// Description: data channels transformation from postImage to ram
// 
// Dependencies: 
// 
// Revision:
...
begin
		...
		`POSTIMAGE_CHANNEL'h02:
			q_temp[1]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h04:
			q_temp[2]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h08:
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h10:
			q_temp[4]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h20:
			q_temp[5]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h40:
			q_temp[6]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
		`POSTIMAGE_CHANNEL'h80:
			q_temp[7]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			

		
		`POSTIMAGE_CHANNEL'h05:begin
			q_temp[0]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[2]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end
		`POSTIMAGE_CHANNEL'h0A:begin
			q_temp[1]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end	
		
		`POSTIMAGE_CHANNEL'h09:begin
			q_temp[0]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[4]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end	
		`POSTIMAGE_CHANNEL'h12:begin
			q_temp[2]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[5]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end	
		`POSTIMAGE_CHANNEL'h24:begin
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[6]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end	
		...
		`POSTIMAGE_CHANNEL'h88:begin
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[7]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];		
		end
		...
		`POSTIMAGE_CHANNEL'h15:begin
			q_temp[0]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[2]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];
			q_temp[4]	<=	data[`POSTIMAGE_BITWIDTH*3-1:`POSTIMAGE_BITWIDTH*2];
		end	
		`POSTIMAGE_CHANNEL'h2A:begin
			q_temp[1]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];
			q_temp[5]	<=	data[`POSTIMAGE_BITWIDTH*3-1:`POSTIMAGE_BITWIDTH*2];
		end		
		...
		`POSTIMAGE_CHANNEL'h55:begin
			...
			q_temp[2]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];
			q_temp[4]	<=	data[`POSTIMAGE_BITWIDTH*3-1:`POSTIMAGE_BITWIDTH*2];
			q_temp[6]	<=	data[`POSTIMAGE_BITWIDTH*4-1:`POSTIMAGE_BITWIDTH*3];
		end	
		`POSTIMAGE_CHANNEL'hAA:begin
			q_temp[1]	<=	data[`POSTIMAGE_BITWIDTH-1:0];
			q_temp[3]	<=	data[`POSTIMAGE_BITWIDTH*2-1:`POSTIMAGE_BITWIDTH];
			q_temp[5]	<=	data[`POSTIMAGE_BITWIDTH*3-1:`POSTIMAGE_BITWIDTH*2];
			q_temp[7]	<=	data[`POSTIMAGE_BITWIDTH*4-1:`POSTIMAGE_BITWIDTH*3];
		end	
