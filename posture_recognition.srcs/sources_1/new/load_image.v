...
reg	[7:0]	num = 0;//number of the image
reg	[`IMAGE_SIZE-1:0]	row_cnt = 0;//row counter
reg	[`IMAGE_SIZE-1:0]	col_cnt = 0;//column counter
reg	[`KERNEL_SIZE-1:0]	kernel_cnt = 0;//counter for kernel
