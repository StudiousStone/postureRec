...
parameter	HEAD_FILE	=	"D:/postureRec/posture_recognition/posture_recognition.srcs/sim_1/imports/file_ddr/conv1_bin";
parameter	KERNEL_FILE	=	"D:/postureRec/posture_recognition/posture_recognition.srcs/sim_1/imports/file_ddr/para.bin";
parameter	IMAGE_FILE1	=	"D:/postureRec/posture_recognition/posture_recognition.srcs/sim_1/imports/file_ddr/image1.bin";
parameter	IMAGE_FILE2	=	"D:/postureRec/posture_recognition/posture_recognition.srcs/sim_1/imports/file_ddr/image2.bin";

parameter	TEMP_IMAGE	=	"D:/postureRec/posture_recognition/posture_recognition.srcs/sim_1/imports/file_ddr/temp_image";
...
task automatic write_data(
	...
	else if(awaddr_s >= `IMAGE_BASE_ADDR2)
...
task automatic read_data(
	...
	//read head
	if(araddr_s<`KERNEL_BASE_ADDR && araddr_s>=`HEAD_BASE_ADDR)begin//head data
		file_out=$fopen(HEAD_FILE,"rb");	
		araddr_s=araddr_s-`HEAD_BASE_ADDR;	
	end
	//read kernel
	else if(araddr_s>=`KERNEL_BASE_ADDR && araddr_s<`IMAGE_BASE_ADDR1)begin
	...
	//read image2
	else if(araddr_s>=`IMAGE_BASE_ADDR2)begin
